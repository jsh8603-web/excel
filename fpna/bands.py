...
BANDS = {
    ...
    # pack/투자심사 sanity anchor (R3 Damodaran 디폴트 동반) — 자릿수 오류 한정.
    "dscr": (1.0, 5.0),         # 부채상환능력 DSCR(1.0=간신히, 5.0=초우량). <1=상환부족 의심
    "terminal_growth": (-0.02, 0.05),  # 영구성장률 g(통상 −2%~5%, 장기 GDP 상한). >5%=과대 TV 의심
}
